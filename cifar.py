...
class MY_CIFAR10(VisionDataset):
    ...
    def __init__(self, root, train=True, transform=None, target_transform=None,
                 download=False, rate_partial=0.3, flag_aug=True):
        ...
        pickle.dump(self.partial_labels, open('partial_labels_{}.pkl'.format(self.rate_partial), 'wb'))
    ...
    def generate_partial_labels(self):
        if (self.rate_partial != -1):
            ...
            with torch.no_grad():
                ...
                if c == 10:
                    probs, _, _ = read_pkl('probs_cifar10')
                elif c == 100:
                    probs, _, _ = read_pkl('probs_cifar100')
